...
LABEL org.opencontainers.image.description="NAME" \
      ...
      org.opencontainers.image.authors="Nho Luong (https://www.linkedin.com/in/nholuongut)" \
      org.opencontainers.image.url="https://ghcr.io/nholuongut/REPO" \
      org.opencontainers.image.documentation="https://hub.docker.com/r/nholuongut/REPO" \
      ...
      #org.opencontainers.image.url="https://hub.docker.com/r/nholuongut/REPO" \
...
RUN apk add --no-cache curl && \
    curl -sS https://raw.githubusercontent.com/nholuongut/DevOps-Bash-tools/master/clean_caches.sh | sh && \
    apk del curl && \
...
#
#   https://github.com/nholuongut/GitHub-Actions/blob/master/.github/workflows/codeartifact_secret.yaml
#
