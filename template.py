...
try:
    ...
    #from nholuongut.utils import CriticalError, UnknownError
    from nholuongut.utils import validate_host, validate_port, validate_user, validate_password
    from nholuongut.utils import isStr
    from nholuongut import CLI
    from nholuongut import RestNagiosPlugin
